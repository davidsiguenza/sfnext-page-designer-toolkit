...
export const operations = {
  ...
  getProductImages: { m: 'GET' as const, b: BASE_PATH, s: '/products/{productId}/images' },
  getProductPrices: { m: 'GET' as const, b: BASE_PATH, s: '/products/{productId}/prices' },
  getProductPromotions: { m: 'GET' as const, b: BASE_PATH, s: '/products/{productId}/promotions' },

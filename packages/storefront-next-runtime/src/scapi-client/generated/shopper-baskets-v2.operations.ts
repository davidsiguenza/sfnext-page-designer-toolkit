 ...
 * - Base path extraction: Saves ~1482 bytes
 * - Abbreviated keys: Saves ~494 bytes (m=method, b=base, s=suffix)
 * - Total savings: ~1976 bytes
 *
...
export const operations = {
  ...
  promoteTemporaryBasket: { m: 'POST' as const, b: BASE_PATH, s: '/{basketId}/actions/promote' },

 ...
 * - Base path extraction: Saves ~80 bytes
 * - Abbreviated keys: Saves ~26 bytes (m=method, b=base, s=suffix)
 * - Total savings: ~106 bytes
 *
...
export const BASE_PATH = '/organizations/{organizationId}/payment-' as const;

export const operations = {
  getPaymentConfiguration: { m: 'GET' as const, b: BASE_PATH, s: 'configuration' },
  getPaymentInstrumentBalance: { m: 'POST' as const, b: BASE_PATH, s: 'instruments/balance' }
} as const;

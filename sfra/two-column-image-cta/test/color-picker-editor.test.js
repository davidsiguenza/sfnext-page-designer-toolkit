...
assert.strictEqual(colorPicker.isValidCssColor('oklch(62% 0.2 250)'), false);
assert.strictEqual(colorPicker.isValidCssColor('lab(50% 20 30)'), false);
assert.strictEqual(colorPicker.isValidCssColor('color-mix(in srgb, red, blue)'), false);

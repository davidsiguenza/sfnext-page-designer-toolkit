...
(function (root, factory) {
    ...
    function validityFor(value) {
        ...
        if (value && !isValidCssColor(value)) {
            return {
                valid: false,
                message: 'Introduce un color CSS válido, por ejemplo #0057B8.'
            };
        }
    ...
    function createMarkup() {
        ...
        editor.innerHTML = [
            ...
            '  <label class="pd-color-picker__assistive" for="pd-color-picker-native">Selector visual de color</label>',
            '  <input class="pd-color-picker__native" id="pd-color-picker-native" type="color" value="#00a1e0" title="Abrir selector de color">',
            '  <label class="pd-color-picker__assistive" for="pd-color-picker-value">Color CSS</label>',
            ...
            '  <button class="pd-color-picker__clear" type="button">Limpiar</button>',
            '</div>',
            '<span class="pd-color-picker__palette-label">Paleta rápida</span>',
            '<div class="pd-color-picker__palette" role="group" aria-label="Paleta rápida"></div>',

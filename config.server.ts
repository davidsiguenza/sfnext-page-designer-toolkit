        ...
        app: {
            ...
            security: {
                ...
                headers: {
                    ...defaultSecurityHeaders,
                    csp: {
                        ...defaultSecurityHeaders.csp,
                        directives: {
                            ...defaultCspDirectives,
                            'frame-src': [
                                ...(defaultCspDirectives['frame-src'] ?? []),
                                // Privacy-enhanced providers supported by SFNextToolkit.embeddedVideo.
                                'https://www.youtube-nocookie.com',
                                'https://player.vimeo.com',
                            ],
                            'media-src': [
                                ...(defaultCspDirectives['media-src'] ?? ["'self'"]),
                                // Merchant-authored direct videos and captions are restricted to HTTPS by the component.
                                'https:',
                                // B2C content-library media origins are kept explicit for restrictive defaults.

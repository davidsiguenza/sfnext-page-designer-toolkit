...
describe('Region', () => {
    ...
    it('renders an empty nested component region as an authoring drop zone in design mode', () => {
        vi.mocked(usePageDesignerMode).mockReturnValue({ isDesignMode: true, isPreviewMode: false });
        const emptyRegion = { id: 'items', components: [] };
        const mockComponent = {
            id: 'accordion-1',
            typeId: 'SFNextToolkit.accordion',
            regions: [emptyRegion],
            designMetadata: {
                id: 'accordion-1',
                regionDefinitions: [
        ...
        render(<Region component={mockComponent} regionId="items" />);
    ...
    it('synthesizes a missing nested region from design metadata in authoring mode', () => {
        vi.mocked(usePageDesignerMode).mockReturnValue({ isDesignMode: true, isPreviewMode: false });
        const mockComponent = {
            id: 'trust-bar-1',
            ...
            designMetadata: {
                id: 'trust-bar-1',
                regionDefinitions: [{ id: 'items', name: 'Items' }],
            },
        } as unknown as ComponentType;

        render(<Region component={mockComponent} regionId="items" />);

        expect(capturedDesignMetadata).toMatchObject({ id: 'items' });
    });

...
describe('ProductImage', () => {
    ...
    it('shows the fallback immediately when no image source is available', () => {
        render(<ProductImage src="" alt="Missing image" />);

        expect(screen.getByText('No image available')).toBeInTheDocument();
        expect(DynamicImageMock).not.toHaveBeenCalled();
    });

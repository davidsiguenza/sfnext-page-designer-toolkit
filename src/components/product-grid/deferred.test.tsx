...
describe('DeferredProductGrid — three-phase rendering', () => {
    ...
    test('preserves tile presentation in the pre-idle fallback', () => {
        vi.mocked(useDeferredRender).mockReturnValue(false);
        ...
        renderDeferred({
            ...
            nonCriticalCount: 2,
            tilePresentation: largeTilePresentation,
        });
    ...
    test('preserves tile presentation after non-critical products resolve', async () => {
        vi.mocked(useDeferredRender).mockReturnValue(true);
    ...
    test('preserves tile presentation in the pending Suspense fallback', () => {
        vi.mocked(useDeferredRender).mockReturnValue(true);

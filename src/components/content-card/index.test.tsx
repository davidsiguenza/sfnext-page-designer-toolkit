...
describe('ContentCard', () => {
    ...
    test('renders an empty alternative when the image is decorative', () => {
        renderWithRouter(<ContentCard {...defaultProps} decorativeImage />);
        expect(screen.getByRole('presentation')).toHaveAttribute('alt', '');
    });

    test('renders a Page Designer library image stored as path', () => {
        renderWithRouter(<ContentCard {...defaultProps} imageUrl={{ path: '/images/editorial/card.webp' }} />);

        expect(screen.getByAltText('Test image')).toHaveAttribute('src', '/images/editorial/card.webp');
    });

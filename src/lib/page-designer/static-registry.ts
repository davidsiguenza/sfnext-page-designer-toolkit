...
export function initializeRegistry(targetRegistry = registry): void {
    ...
    targetRegistry.registerImporter(
        'SFNextToolkit.countdownBand',
        () => import('../../components/sfnext-toolkit/countdown-band/index'),
        { loader: 'loader', fallback: 'fallback' }
    );
    targetRegistry.registerImporter(
    ...
    targetRegistry.registerImporter(
        ...
        () => import('../../components/sfnext-toolkit/shoppable-image/index'),
        { loader: 'loader', fallback: 'fallback' }
    );
    targetRegistry.registerImporter(
        'SFNextToolkit.siteTheme',
        () => import('../../components/sfnext-toolkit/site-theme/index'),
        { fallback: 'fallback' }
    );
    targetRegistry.registerImporter(
        'SFNextToolkit.sizeGuide',
        () => import('../../components/sfnext-toolkit/size-guide/index'),
        { fallback: 'fallback' }
    );
    targetRegistry.registerImporter(
